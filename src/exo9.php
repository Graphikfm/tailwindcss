...
<div class="global_container rounded-xl w-1/3 h-3/5 bg-gray-200 flex flex-col m-7 justify-center relative  shadow-md  p-7">
    <div class="nav w-full flex mb-2 justify-between gap-1">
        <a class="container_btn_left bg-gray-900  <?php if ($year === ($currentYear-5)) { ?> cursor-not-allowed bg-zinc-300  <?php } ?> w-12 h-8 rounded-l-lg flex   top-0 right-0 justify-center items-center text-white " <?php if ($year === ($currentYear-5)) { ?> href="" <?php } ?> href="/src/exo8.php?year=<?php echo $year-1 ?> ">
        ...
        <div  class="dropdownContainer cursor-pointer justify-center items-center   bg-green-400  relative flex  w-full">
        ...
        <a class="container_btn_left bg-gray-900  <?php if ($year === ($currentYear+5)) { ?> cursor-not-allowed bg-zinc-300  <?php } ?> w-12 h-8 rounded-r-lg flex   top-0 right-0 justify-center items-center text-white " <?php if ($year === ($currentYear+5)) { ?> href="" <?php } ?> href="/src/exo8.php?year=<?php echo $year+1 ?> ">
