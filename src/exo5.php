...
if ($year === null) {
    ...
    header('Location: /src/exo5.php?year='.$year);
}
...
//     var_dump($date);
    ...
    <div class="h-full flex items-center justify-center flex-col ">
        ...
        <?php } ?>
        <a class="  container_btn_left shadow-black shadow-md bg-gray-900 w-16 h-16 rounded-lg flex justify-center items-center text-white" href="/src/exo5.php?year=<?php echo $sub ?>">
    ...
    <div class="h-full flex justify-center  flex-col">
        ...
        <?php } ?>
        <a class=" container_btn_right shadow-black shadow-md bg-gray-900 w-16 h-16 rounded-lg flex justify-center items-center text-white" href="/src/exo5.php?year=<?php echo $add ?>">
