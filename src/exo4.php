...
<?php } ?>
    <a class="  container_btn_left shadow-black shadow-md bg-gray-900 w-16 h-16 rounded-lg flex justify-center items-center text-white" href="/src/exo4.php?year=<?php echo $sub ?>">
...
<?php } else { ?>
    ...
    <?php } ?>
        <a class=" container_btn_right shadow-black shadow-md bg-gray-900 w-16 h-16 rounded-lg flex justify-center items-center text-white" href="/src/exo4.php?year=<?php echo $add ?>">
